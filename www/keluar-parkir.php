  ...
  <div>
    ...
    ?>
      <form action="buyar.php" method="post">
        ...
        <input readonly type="text" id="plat_nomor" name="plat_nomor" value="<?php echo $data['plat_nomor'] ?>">

        <label for="jenis"></label>
        <input readonly type="text" id="jenis" name="jenis" value="<?php echo $data['jenis'] ?>">

        <label for="waktu_masuk">Waktu Masuk</label>
        <input readonly readonly type="text" id="waktu_masuk" name="waktu_masuk" value="<?php echo $data['waktu_masuk'] ?>">

        <label for="waktu_keluar">Waktu Keluar</label>
        <input readonly readonly type="text" id="waktu_keluar" name="waktu_keluar" value="<?php $tgl = date('Y-m-d h:i:s');
                                                                                          echo $tgl; ?>">
